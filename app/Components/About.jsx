      ...
      <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
        ...
        <div className="flex-1">
          <p className="mb-10 max-w-2xl font-Ovo">
            i am an expreienced Frontend Developer with over a decade of
            professional expertise in crafting visually appealing and
            user-friendly websites and applications. My journey in web
            development has equipped me with a deep understanding of the latest
          </p>
